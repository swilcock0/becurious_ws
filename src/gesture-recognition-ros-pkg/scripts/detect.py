...
def callback(data):
    ...
    global num_frames
    img = cv_bridge.imgmsg_to_cv2(data, "bgr8")  # Convert ROS image to CVMat
    frame = img
    # resize the frame
...
if __name__ == "__main__":
    ...
    # Setup image subscriber and gesture pub
    publisher = rospy.Publisher('/gesture_channel', String, queue_size=10)
    img_subscriber = rospy.Subscriber("/webcam/image_raw", Image, callback)

    # initialize weight for running average
    aWeight = 0.5


    # Get reference to cv bridge
    bridge = CvBridge()
    ...
    top, right, bottom, left = 10, 200, 400, 590
